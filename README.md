...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-07-10 10:39`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/553cf622-fec8-4c8d-a49e-583a1dc1502e.git
$ cd 553cf622-fec8-4c8d-a49e-583a1dc1502e
```
